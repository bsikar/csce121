...
// throw std::overflow_error if the sum exceeds the maximum/minimum value of a
// signed 32-bit integer.
int SumBetween(int low, int high);

// return the product of a and b
// throw std::overflow_error if the product exceeds the maximum/minimum value of
