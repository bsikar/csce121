...
public:
  ...
  Rover()
      : savedSMILE("") {
  } // MyString: parameterized constructor (const char* type)
  Rover(MyString newSMILE)
      : savedSMILE(newSMILE) {
  } // MyString: parametered constructor (MyString type), i.e., copy constructor

  // getters
  MyString getSMILE() { return savedSMILE; }

  // setters
  void setSMILE(MyString SMILE) {
    savedSMILE = SMILE;
  } // MyString: operator=(), copy assignment constructor
